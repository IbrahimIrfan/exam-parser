...
var server_file = cluster + '_' + q + '_Split_' + type + '_Server.php';
var jsonfilelocation = '/Users/ibrahimirfan/Desktop/scratch/exams/' + cluster + '/' + cluster + '_' + json_q + '_Questions.json';
var jsonfilelocation2 = '/Users/ibrahimirfan/Desktop/scratch/exams/' + cluster + '/' + cluster + '_' + json_q + '_Answers.json';
var phpfilelocation = '/Users/ibrahimirfan/Desktop/DECA-Web-App/' + cluster + '_' + q + '_Split_' + type + '.php';
var phpfilelocation2 = '/Users/ibrahimirfan/Desktop/DECA-Web-App/' + cluster + '_' + q + '_Split_' + type + '_Server.php';
var jsfilelocation = '/Users/ibrahimirfan/Desktop/DECA-Web-App/' + cluster + '_' + q + '_Split_' + type + '.js';
var jsfile = cluster + '_' + q + '_Split_' + type + '.js';
...
string += '<input id="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" type="submit"></input>' +
    '</form></div>'
string += '</body><script src="jquery-timer/jquery.simple.timer.js"></script><script src="' + jsfile + '"></script></html>';
