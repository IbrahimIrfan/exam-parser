...
var file = cluster + "_" + q + "_Answers";
var file2 = cluster + "_" + q + "_Questions";
...
var jsonfilelocation2 = '/Users/ibrahimirfan/Desktop/scratch/exams/' + cluster + '/' + file2 + '.json';
